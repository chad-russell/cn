--- Fixed query_predicates.lua for Neovim 0.12 compatibility.
--- In 0.12, match[id] returns a list of nodes instead of a single node.
--- The original nvim-treesitter plugin is archived and won't be fixed.
---
--- This file shadows lua/nvim-treesitter/query_predicates.lua via nixvim extraFiles.
...
-- Neovim 0.12 compat: match[id] returns a list of nodes; unwrap to single node.
...
query.add_predicate("nth?", function(match, _pattern, _bufnr, pred)
  ...
  local node = unwrap(match, pred[2]) ---@type TSNode
