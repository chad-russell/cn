...
#
# Output:
#   localhost/host-image-thinkpad:<FEDORA_MAJOR_VERSION>            (rolling; what switch.sh targets)
#   localhost/host-image-thinkpad:<FEDORA_MAJOR_VERSION>-<sha>-<ts> (immutable; per-build, for history)
set -euo pipefail
...
VERSION_TAG="localhost/host-image-thinkpad:${IMAGE_VERSION}"
...
echo "  sudo podman images localhost/host-image-thinkpad"
echo
