...
This image is based on [Silverblue Main](https://github.com/ublue-os/bluefin) and includes these customizations:
...
- **GPU Support**: vulkan-loader for GPU acceleration
