...
in
{
  ...
  networking.hosts = {
    "127.0.0.1" = [ "hb-api.gloo.local" "hb-web.gloo.local" "storyhub.gloo.local" "gpl.gloo.local" "polymer.gloo.local" "minio.gloo.local" "pgadmin.gloo.local" "open-bible.gloo.local" ];
  };
}
