...
# Vendored into brunch from servers/hub/dev-stacks/gloo/scripts/render-runtime-env.sh
# This copy lives in the brioche store; host-dependent paths are hardcoded below.
# The canonical on-disk copy at servers/hub/dev-stacks/gloo/scripts/render-runtime-env.sh
# derives paths relative to $0 instead.
...
SERVICE="$1"
GLOO_ROOT="/var/home/crussell/Code/cn/servers/hub/dev-stacks/gloo"
ENV_DIR="$GLOO_ROOT/host-envs"
SECRETS_FILE="$GLOO_ROOT/secrets/gloo-secrets.env.age"
