...
#
# Layout (modeled after hosts/bee/disk-config.nix but larger):
#   /dev/nvme0n1:
#     p1: 1G    EFI
...

{
  ...
  # secrets (and services that depend on them, e.g. Caddy on bees) fail to come
  # up after a reboot. See modules/base-server.nix (age.identityPaths).
