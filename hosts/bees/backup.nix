...

{
  ...
  services.homelab-backup = {
    ...
    paths = [
      ...
      # Web services (data + papra auth secret)
      "/var/lib/papra"
      "/var/lib/linkding"
      ...
      # user quadlet's bind-mount dir. db + -wal are backed up together —
      # SQLite recovers the pair cleanly; a bare .db without its WAL loses
