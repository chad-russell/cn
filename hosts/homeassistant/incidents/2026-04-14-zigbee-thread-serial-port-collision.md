...
- Host guide: `hosts/homeassistant/README.md`
- SSH helper: `hosts/homeassistant/scripts/ha-ssh.sh`
- Supervisor helper: `hosts/homeassistant/scripts/ha-supervisor.sh`
- Radio audit helper: `hosts/homeassistant/scripts/ha-radio-audit.sh`
