-- vim options. Ported from the nixvim module `opts` + extraConfigLua.
...
opt.backup = false
opt.undofile = true
-- Keep undo history in the bubblebox-isolated data dir (see the nvim entrypoint),
-- so .un~ files don't leak next to the host files you edit.
